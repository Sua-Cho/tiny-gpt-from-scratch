...
# 1. Load data
# -----------------------------
file_name = input("학습할 txt 파일 이름을 입력하세요 (예: input.txt): ")
...
# -----------------------------
@torch.no_grad()
def generate(model, start_text, max_new_tokens, block_size, stoi, itos, device):
    model.eval()
...
start_text = input("시작 문장을 입력하세요 (예: ROMEO:): ")
